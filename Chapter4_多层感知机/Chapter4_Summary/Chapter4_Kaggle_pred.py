...
def train_and_pred(train_feature, test_feature, train_labels, test_data, num_epochs, lr, weight_decay, batch_size):
    net = get_net()
    ...
    submission = pd.concat([test_data, test_data['Id'], test_data['SalePrice']], axis=1)
    submission.to_csv('submission.csv', index=False)
#%%
k, num_epochs, lr, weight_decay, batch_size = 5, 300, 0.001, 0.005, 64
